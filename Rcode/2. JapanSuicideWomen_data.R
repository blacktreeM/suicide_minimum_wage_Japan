...
table(data$year)
# 2022-2024
df1 = read_xls(files[14], sheet = 3)[-c(1:6),]
(mk = df1[1,])
colnames(df1) = mk[1,]
df1 = df1[-1,]
df1$year = 2022
df2 = read_xls(files[15], sheet = 3)[-c(1:6),]
colnames(df2) = colnames(df1)
df2 = df2[-1,]
df2$year = 2023
df3 = read_xls(files[16], sheet = 3)[-c(1:6),]
...
data = rbind(data, df)
table(data$year)
save(data, file = 'suicideWomen.RDa')